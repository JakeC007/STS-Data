...
add at end of document production for naviation ease 
...
KF2_T1 <- summary(likert(df_f3.reverse[,c(1:3)], grouping = df_f3.reverse[,4]))
KF2_T1 <- KF2_T1[, c(1,2,3,5,6,7)] # remove neutral column b/c it isn't relevant
knitr::kable(KF2_T1, "simple", caption = "Summary Statistics of Key Figure 2")
```


WHAT DO THEY WANT FOR A NUMERIC SUMMARY THAT INVOLVES UNCERTAINTY
